...
class AndroidPebbleTimelineActions(
    private val libPebble: LibPebble,
...
class AndroidPebbleWatchInfoActions(
    private val libPebble: LibPebble,
) : PebbleWatchInfoActions {
    override fun getWatchBatteryLevel(): Int? {
        // TODO: implement Android-specific quiet time actions if needed
        return null
    }
    ...
    override fun getConnectedWatchName(): String? {
         // TODO: implement Android-specific quiet time actions if needed
        return null
    }

    override suspend fun getWatchScreenshotBase64(): String {
        // TODO: implement Android-specific screenshot actions if needed
        return ""
    }

    override fun setBacklightMotion(enabled: Boolean) {
        // TODO: implement Android-specific backlight motion actions if needed
    }
}

class AndroidPebbleHealthActions(
    private val libPebble: LibPebble,
) : PebbleHealthActions {
