...
fun IndexWebhookSettingsDialog(
    ...
    val gesture = editingGesture ?: return
...
fun IndexWebhookGesture.displayName(): String = when (this) {
    IndexWebhookGesture.SingleClickHold -> "Single click & hold"
    IndexWebhookGesture.DoubleClickHold -> "Double click & hold"
}
